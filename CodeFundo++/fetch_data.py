...
def alert():
    ...
    if(var==0):
        ...
        print("Moderate rain falling, keep your umbrella with you, but you're safe")
    elif(var==2):
        print("Heavy raining, chances of floods increasing. Please take necessary precations ")
    else:
        print("Flood chances are at peak.Stay in your house")
